...
mod tests {
    ...
    fn test_validate_input_file_exists() {
        ...
        let result = validate_input_file(file_path.to_str().unwrap());
        assert!(result.is_ok());
    }
    ...
    fn test_validate_positive_int() {
        assert_eq!(validate_positive_int("5", "test").unwrap(), 5);
    ...
    fn test_validate_positive_float() {
        assert_eq!(validate_positive_float("3.5", "test").unwrap(), 3.5);
